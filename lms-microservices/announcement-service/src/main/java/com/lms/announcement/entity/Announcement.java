...
public class Announcement {
     ...
     * COURSE    → étudiants d'un cours (targetId = courseCode)
     * CLASS     → étudiants d'une classe (targetId = classId)
     */
    ...
    /**
     * Identifiant de la cible (courseCode ou classId).
     * Null si targetAudience = ALL / STUDENTS / LECTURERS.
     */
